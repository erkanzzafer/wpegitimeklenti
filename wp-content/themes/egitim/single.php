                ...
                <div class="container">
                    ...
                    <div class="blog-post date-style-3 blog-post-single">
                        <div class="wt-post-media wt-img-effect">
                            <a href="javascript:void(0);"><img src="<?php echo wp_get_attachment_image_src(get_post_thumbnail_id(),'full')[0]; ?>" alt="<?php the_title();?>"></a>
                        </div>
                        <div class="post-description-area p-t30">
                            ...
                            <div class="wt-post-meta ">
                              <ul>
                                <li class="post-date"> <i class="fa fa-calendar"></i><strong><?php echo get_the_date('d M');?></strong> <span> <?php echo get_the_date('Y');?></span> </li>
                                <li class="post-author"><i class="fa fa-user"></i><a href="javascript:void(0);">Yazar <span><?php the_author();?></span></a> </li>
                                <li class="post-comment"><i class="fa fa-comments"></i> <a href="javascript:void(0);"><?php echo get_comments_number();?></a> Yorum </li>
                              </ul>
                            </div>
                    ...
                    <div class="section-content p-t50">
                        ...
                        <div class="section-head">
                            <h2 class="text-uppercase">İlgili Yazılar</h2>
                                    ...
                                    <div class="item">
                                         <div class="blog-post blog-grid date-style-3">
                                            <div class="wt-post-media wt-img-effect zoom-slow">
                                                <a href="javascript:void(0);"><img src="<?php echo wp_get_attachment_image_src(get_post_thumbnail_id(),'oneCikan')[0]; ?>" alt="<?php the_title();?>" alt="<?php the_title();?>"></a>
                                            </div>
                    ...
                    <div class="clear" id="comment-list">
                        <div class="comments-area" id="comments">
                            <h2 class="comments-title"><?php comments_number('Yorum yapılmamış','1 yorum','% Yorum'); ?></h2>
                            <div class="p-tb30">
                            <?php comments_template();?>

                                  <?php comment_form(array(
                                  	"class-submit" =>"site_button uppercase",
