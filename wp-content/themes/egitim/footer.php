                       ...
                       <div class="col-md-3 col-sm-6  p-tb20">
                           <div class="wt-icon-box-wraper left  bdr-1 bdr-gray-dark p-tb15 p-lr10 clearfix">
                                ...
                                <div class="icon-content text-secondry">
                                    ...
                                    <p class="m-b0"><?php echo $ayar['iletisim_fax']; ?></p>
                        ...
                        <div class="col-md-3 col-sm-6">  
                            <div class="widget widget_about">
                                ...
                                <div class="logo-footer clearfix p-b15">
                                    <a href="index.html"><img src="<?php echo $ayar['site_logo']['url'] ?>" width="171" height="49" alt=""/></a>
                                </div>
                                <p><?php echo $ayar['site_footer_aciklama']; ?>
                                </p>  
                            </div>
                        </div> 
                        <!-- RESENT POST -->
                                    ...
                                    <div class="bdr-light-blue widget-post clearfix  bdr-b-1 m-b10 p-b10">
                                        ...
                                        <div class="wt-post-info">
                                            <div class="wt-post-header">
                                                <h6 class="post-title"><a href="blog-single.html"><?php echo get_the_title(); ?> </a></h6>
                                            </div>
                            ...
                            <div class="widget widget_newsletter">
                                ...
                                <div class="newsletter-bx">
                                    <form role="search" method="post" action="">
                                        ...
                                        <input name="news-letter" class="form-control" placeholder="Abonelik için email adresi" type="text">
                ...
                <div class="container p-t30">
                    <div class="row">
                        <div class="wt-footer-bot-left">
                            <span class="copyrights-text"><?php echo $ayar['site_footer']; ?></span>
                        </div>
